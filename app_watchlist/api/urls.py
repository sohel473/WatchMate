...
from app_watchlist.api.views import ReviewDetail, ReviewList, StreamViewSet, UserReview, WatchListAV, WatchListDetailsAV
...
urlpatterns = [
    ...
    path('watch/reviews/', UserReview.as_view(), name='user-review'),
]
