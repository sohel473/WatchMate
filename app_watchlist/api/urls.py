...
from app_watchlist.api.views import ReviewDetail, ReviewList, StreamViewSet, AllReview, WatchListAV, WatchListDetailsAV, WatchListGV
...
urlpatterns = [
    ...
    path('watch/reviews/', AllReview.as_view(), name='user-review'),
]
